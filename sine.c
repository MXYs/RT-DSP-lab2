...
//Array of floats containing elements of sine_table_size
...
float b0 = 0.707;
float index = 0.0;	//Increments to sample number 
...
float sinegen(void)
{
//  This code produces a sine wave of variable frequency using a lookup table.
...
void sineinit()
{
//	This function takes 256 samples of one cycle of a sine wave and stores these values in a lookup table
